...
$query_cek = mysqli_query($koneksi, $sql2);
      ...
      <div class="row">
        ...
        <div class="card-body p-0">
          <table align="center" border="0" cellpadding="1" style="width: 700px;"><tbody>
            ...
            $sql_tampil = "SELECT tb_penawaran.kode_penawaran,tb_pesanan.kode_pesanan, tb_pesanan.nama_pengguna, tb_pesanan.alamat, tb_desain.nama_desain, tb_desain.foto_desain, tb_pengguna.no_hp, tb_penawaran.biaya_dp, tb_penawaran.total_bayar, tb_penawaran.ttd_admin, tb_penawaran.ttd_pelanggan FROM tb_pesanan 
            ...
            JOIN tb_penawaran ON tb_pesanan.kode_pesanan=tb_penawaran.kode_pesanan WHERE tb_pesanan.kode_pesanan=$kode_pesanan";
                  ...
                  <tr>     
                    ...
                    <tr>     <td colspan="3" height="270" valign="top"><div align="justify">
                      ...
                      <tr>     <td><div align="center">
                        ...
                        <div align="center">
                          <?php
                          if(!empty($data['ttd_pelanggan'])){
                            ?>
                            <img src="admin/foto/ttd_pelanggan/<?=$data['ttd_pelanggan']; ?>" width="100px"/>
                          <?php }else{?>
                            <br>
                        ...
                        <div align="center">
                          ...
                          <div align="center">
                            <img src="admin/foto/ttd_admin/<?=$data['ttd_admin']; ?>" width="100px"/>
                          </div>
                          <div align="center">
          ...
          if(isset($_POST['signaturesubmit'])){ 
            ...
            // biaya_dp=$data['biaya_dp'],
            // total_bayar=$data['total_bayar'],
            // ttd_pelanggan=$signatureFileName,
            // ttd_admin=$data['ttd_admin'],
            // timestamp=NOW()   
