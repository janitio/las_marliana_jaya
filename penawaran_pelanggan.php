...
$sql_tampil = "SELECT tb_penawaran.kode_penawaran,tb_pesanan.kode_pesanan, tb_pesanan.nama_pengguna, tb_pesanan.alamat, tb_desain.nama_desain, tb_desain.foto_desain, tb_pengguna.no_hp, tb_penawaran.biaya_dp, tb_penawaran.total_bayar, tb_penawaran.ttd_admin, tb_penawaran.ttd_pelanggan, tb_penawaran.timestamp FROM tb_pesanan 
...
JOIN tb_penawaran ON tb_pesanan.kode_pesanan=tb_penawaran.kode_pesanan WHERE tb_pesanan.kode_pesanan='".$_GET['kode_pesanan']."'";
$query_tampil = mysqli_query($koneksi, $sql_tampil);
$no=1;
while ($tampil= $query_tampil->fetch_assoc()) {

	$kode_penawaran=$tampil['kode_penawaran'];
...
<main id="main">
	...
	if(isset($_GET['kode_pesanan'])){
		...
		if (empty($data_cek['kode_penawaran'])) {
			echo "<script>
			...
			<section class="inner-page pt-3">
									...
									<tr>         
										<td width="93">
											...
											<td width="8">
												<span >:</span></td>         
												<td width="200">
													<span ><?=$kode_penawaran?></span></td>       </tr>
													<tr>         
										...
										<tr>     
												...
												<tr>     <td colspan="3" height="270" valign="top"><div align="justify">
													...
													<table>
														<tr>
															...
															<td style="width: 5%;">:</td>
															<td style="width: 65%;"><?=$nama_pengguna?></td>
														</tr>
														<tr>
															<td style="width: 30%;">No. HP</td>
															<td style="width: 5%;">:</td>
															<td style="width: 65%;"><?=$no_hp?></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td style="width: 5%;">:</td>
															<td style="width: 65%;"><?=$kode_pesanan?></td>
														</tr>
														<tr>
															<td style="width: 30%;">Barang yang Akan Dipesan</td>
															<td style="width: 5%;">:</td>
															<td style="width: 65%;"><?=$nama_desain?></td>
														</tr>
														<tr>
															<td style="width: 30%;">Bayar Dimuka</td>
															<td style="width: 5%;">:</td>
															<td style="width: 65%;">Rp. <?php echo number_format($biaya_dp); ?></td>
														</tr>
														<tr>
															<td style="width: 30%;">Harga Total</td>
															<td style="width: 5%;">:</td>
															<td style="width: 65%;">Rp. <?php echo number_format($total_bayar); ?></td>
														</tr>
													</table>
													<div align="justify">
													...
													<tr>     <td><div align="center">
														...
														<div align="center">
															...
															if(!empty($ttd_pelanggan)){
																?>
																<img src="admin/foto/ttd_pelanggan/<?=$ttd_pelanggan; ?>" width="230px"/>
															<?php }else{?>
																<br>
														...
														<div align="center">
															<span ><?=$nama_pengguna?></span></div>
														</td>     <td></td>     <td valign="top"><div align="center">
															<span >Pemilik Jasa, </span></div>
															<div align="center">
																<img src="admin/foto/ttd_admin/<?=$ttd_admin; ?>" width="100px"/>
															</div>
															<div align="center">
																<span >Sawardi</span></div>
															</td>   </tr>
														</tbody>
													</table>
												</body>
											...
											<div class="container center">
												<div class="col-md-8 col-md-offset-2">
													...
													<a href="?page=data-pesanan" title="Batal" class="btn btn-danger">Batalkan</a>
													<a href="admin/report/cetak_penawaran.php?kode_penawaran=<?php echo $data['kode_penawaran']; ?>" target=" _blank" title="Lihat" class="btn btn-primary">Cetak</a>
             ...
             $sql_ubah = "UPDATE tb_penawaran SET
